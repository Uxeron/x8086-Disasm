...
sSPC equ 23h	; reg = 0: write 1; reg = 1: write AL; reg = 2: write AX; reg = 3: write 3; reg = 4: write "far"
sESC equ 24h	; Read next command byte as yyy and then write "reg yyy"
sIAM equ 25h	; Write MSB LSB:AMSB ALSB
sEXT equ 26h	; Execute extended function
...
codes   db 	06h, rBIT,000h,rMWR,wNAM,wROM,wCOM,wREG,  0h,0	; 00	ADD 	r/m, reg		Byte
		...
		db	3Bh, rMWR,sSEG,wNAM,wROM,wCOM,wSEG,  0h,  0h,0	; 8C	MOV		r/m, SEG
		db	33h, rMWR,wNAM,wREG,wCOM,wROM,  0h,  0h,  0h,0	; 8D	LEA		reg, r/m
		db	3Bh, rMWR,sSEG,wNAM,wSEG,wCOM,wROM,  0h,  0h,0 ; 8E	MOV		SEG, r/m
